    ...
    <div class="card mb-4 py-3 border-bottom-primary">
        ...
        <div class="container-fluid">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Rezervasyon (mesajlar ve bazı ksımlar kısaltılmış gösterilir)</h6>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Tarih :<?php echo $row["tarih"]."/".$row["saat"];?>  </h5>
                                            </div>
                ...
                <td> <p  class="overflow-hidden" > <?php  echo substr($row["tarih"]."--".$row["saat"],0,100); ?> </p> </td>
