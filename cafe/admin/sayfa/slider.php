            ...
            <form action="fankfonk/fankfonk.php" method="post" enctype="multipart/form-data">
                <div class="card border-bottom-info ">
                    <div class="card-body">
                        ...
                        <i class="text-center">Başlık 1 </i><br>

                        <input type="text" name="baslik1" value="" ><br>
                        <i class="text-center">Başlık 2 </i><br>
                        <input type="text" name="baslik2" value="" ><br>
                        <i class="text-center">Açıklama </i><br>
                        <input type="text" name="aciklama" value="" >
                        <br>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="fankfonk/fankfonk.php" method="post" name="f<?php echo $row["id"];?>" enctype="multipart/form-data">
                                                            <i class="text-center">Resim </i><br>
                                                            <i class="text-center">Mevcut </i><br>

                                                            <img class="img-thumbnail " width="50%" src=<?php  echo $resim_ana_url.$row["resim"]; ?> >
                                                            ...
                                                            <input type="text" name="baslik1" value="<?php echo $row["baslik"];?>" ><br>
                                                            <i class="text-center">Başlık 2 </i><br>
                                                            <input type="text" name="baslik2" value="<?php echo $row["baslik2"];?>" ><br>
                                                            <i class="text-center">Açıklama </i><br>
                                                            <input type="text" name="aciklama" value="<?php echo $row["aciklama"];?>" >
                                                            <br>
