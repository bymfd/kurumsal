            ...
            <div class="nav ftco-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                if ( $query->rowCount() ){
                    foreach( $query as $row ){ ?>
                        ...
                        <button class="btn btn-default nav-link bg-dark filter-button2 filter <?php echo "kat".$row["main"] ?>"   data-filter2="<?php echo "kat".$row["id"] ?>"> <?php echo $row["isim"] ?></button>
                    <?php }} ?>
                    ...
                    <div class="row">
                        ...
                        if ( $query->rowCount() ){
                            foreach( $query as $ro2w ){ ?>
                                <div class="col-md-3 filter2 <?php echo "kat".$ro2w["kategori"] ?> " >
                                    <div class="menu-entry filter2 <?php echo "kat".$ro2w["kategori"] ?> ">
                                        <a href="#menu" class="img filter2 <?php echo "kat".$ro2w["kategori"] ?>" style="background-image: url(<?php echo $resim_ana_url."/".$ro2w["resim"]  ?>);"></a>
                                        <div class="text text-center pt-4 filter2 <?php echo "kat".$ro2w["kategori"] ?> ">
