...
<head>
    ...
    <meta name="author" content="bymfd">

    <title>Rumors Yönetim</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#ayar" aria-expanded="true" aria-controls="ayar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="?sayfa=kurumsal">Hakkımızda</a>
                    <a class="collapse-item" href="?sayfa=hizmetler">Müşteri Yorumları</a>
                    <a class="collapse-item" href="?sayfa=yaptiklarimiz">MENÜ</a>
                    <a class="collapse-item" href="?sayfa=kategori">Kategori</a>
                </div>
            </div>
        </li>
